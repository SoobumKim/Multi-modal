...
module dds (
    ...
    reg [11:0] phase_post_offset0;
    reg [11:0] phase_post_offset1;

    always @(posedge clk) begin
        phase_post_offset0 <= phase_accumulator0[27:16] + register_phase0;
        phase_post_offset1 <= phase_accumulator1[27:16] + register_phase1;
    end
